  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center animate-slide-up animation-delay-1000 mx-auto">

          {/* Primary Button: Solid, eye-catching */}
          <a
            href="#projects"
            className="group inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-primary to-secondary text-primary-foreground rounded-2xl font-semibold text-lg relative overflow-hidden btn-glow shadow-glow-primary hover:shadow-glow-secondary transition-all duration-300 hover:scale-105"
          >
          ...
          <a
            href="#contact"
            className="group inline-flex items-center justify-center px-8 py-4 bg-transparent border-2 border-primary rounded-2xl font-semibold text-lg hover:bg-primary/10 hover:shadow-glow-primary transition-all duration-300 hover:scale-105"
          >
